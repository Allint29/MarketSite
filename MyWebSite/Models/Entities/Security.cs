...
namespace MyWebSite.Models.Entities
{
    ...
    public class Security
    {
        ...
        public void LoadFromString(string save)
        {
            ...
            PriceStep = Convert.ToDecimal(array[6]);
            Lot = Convert.ToDecimal(array[7]);
            PriceStepCost = Convert.ToDecimal(array[8]);
            Go = Convert.ToDecimal(array[9]);
            Enum.TryParse(array[10], out SecurityType);
            _decimals = Convert.ToInt32(array[11]);
            PriceLimitLow = Convert.ToDecimal(array[12]);
            PriceLimitHigh = Convert.ToDecimal(array[13]);
            Enum.TryParse(array[14], out OptionType);
            Strike = Convert.ToDecimal(array[15]);
